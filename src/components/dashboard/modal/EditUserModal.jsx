...
export const EditUserModal = ({ user, handleEditUser }) => { // Fungsi EditUserModal yang menerima parameter user & handleEditUser
    ...
    const onSubmit = (data) => { // Fungsi onSubmit yang menerima parameter data
        handleEditUser(data) // Jalankan fungsi handleEditUser dengan parameter data
    }
    ...
    return <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className='flex justify-end'>
            <button type="submit" className="bg-orange-500 text-white p-2 rounded-md">Ubah Data</button>
        </div>
